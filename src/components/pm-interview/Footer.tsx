const Footer = () => {
  ...
  const footerSections = [
    {
      title: "Product",
      links: ["Courses", "Cohort", "Quiz", "PM Interview Prep", "Events", "Blog"]
    },
    {
      title: "Company",
    ...
    {
      title: "Resources",
      links: ["Documentation", "Guides", "Help Center", "FAQ", "Community"]
    },
    {
      title: "Legal",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          <div className="col-span-2">
            ...
            <p className="text-gray-600 mb-4">
              Helping product managers prepare for and excel in interviews at top tech companies worldwide.
            </p>
          ...
          {footerSections.map((section, index) => (
            <div key={index}>
              <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wider">{section.title}</h3>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500">
            &copy; {currentYear} Xplainerr. All rights reserved.
          </p>
